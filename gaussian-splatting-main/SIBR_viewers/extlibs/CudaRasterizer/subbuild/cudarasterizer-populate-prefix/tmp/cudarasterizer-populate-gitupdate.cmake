...
execute_process(
  COMMAND "/usr/bin/git" show-ref 3509be80f83ee30599b23bb3542d45aea2174a03
  WORKING_DIRECTORY "/home/rso/codes/gaussian-splatting-main/SIBR_viewers/extlibs/CudaRasterizer/CudaRasterizer"
...
if("${show_ref_output}" MATCHES "refs/remotes/3509be80f83ee30599b23bb3542d45aea2174a03")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3509be80f83ee30599b23bb3542d45aea2174a03")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "3509be80f83ee30599b23bb3542d45aea2174a03")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 3509be80f83ee30599b23bb3542d45aea2174a03
  WORKING_DIRECTORY "/home/rso/codes/gaussian-splatting-main/SIBR_viewers/extlibs/CudaRasterizer/CudaRasterizer"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/graphdeco-inria/diff-gaussian-rasterization.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/rso/codes/gaussian-splatting-main/SIBR_viewers/extlibs/CudaRasterizer/CudaRasterizer/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/rso/codes/gaussian-splatting-main/SIBR_viewers/extlibs/CudaRasterizer/CudaRasterizer/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
